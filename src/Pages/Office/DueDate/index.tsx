  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Vencimentos | Vitrine de Imóveis MS" />
        <meta
          property="og:description"
          content="Vencimentos | Vitrine de Imóveis MS - A forma mais simples de ser visto na internet."
        />
